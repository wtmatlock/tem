...
phylo <- read.tree("~/Desktop/tem1_2024/manuscript/data/GTR_F_I_R4.treefile")

exp <- read_excel("~/Desktop/tem1_2024/manuscript/supplementary/supplementary_table_3.xlsx")
